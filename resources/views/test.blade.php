...
<body class="h-screen overflow-hidden flex items-center justify-center" style="background: #edf2f7;">
    ...
    <div>
            ...
            <div class="md:max-w-6xl md:mx-auto">
                <div class="md:flex md:flex-wrap">
                    <div class="md:w-1/2 text-center md:text-left md:pt-16">
                        <h1 class="uppercase tracking-wider">Free ATM transaction</h1>
                        <p class="tracking-tight">Create an account, deposit virtual money and make free transaction.</p>
                    </div>
                    <div class="md:w-1/2 relative">
                        <div class="">
                            <img class="h-1/2 w-full m-auto" src="{{ asset('images/new_atm.jpg') }}" alt="atm">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <p class="text-center p-4 text-gray-600 pt-10">
            Created by
            <a class="border-b text-blue-500" href="https://twitter.com/mithicher" target="_blank">@mithicher</a>. Inspired by dribble shot
            <a href="https://dribbble.com/shots/8807920-Quickpay-Hero-section/attachments/1015863" target="_blank" class="border-b text-blue-500">https://dribbble.com/vadimdrut</a>
        </p>
    </div>
</body>
</html>